...
export function FeaturedArticle({ post, className = '' }: FeaturedArticleProps) {
  return (
    <div className={`group ${className}`}>
      ...
      <div className="relative overflow-hidden rounded-3xl mb-8 h-[500px] bg-gradient-to-br from-gray-800 to-gray-900">
        ...
        <div className="absolute inset-0 flex items-end p-12">
          <div className="w-full">
            ...
            {/* Excerpt */}
            {post.excerpt && (
              <p className="text-gray-200 text-lg md:text-xl font-medium leading-relaxed max-w-4xl mb-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                href={`/blog/${post.slug}`}
                className="inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-full border border-white/30 hover:bg-white/30 transition-all duration-300 group/link"
              >
                Read full article
